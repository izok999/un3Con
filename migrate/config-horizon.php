...
// Publicar con: php artisan horizon:install
// Luego reemplazar el bloque 'environments' con el de abajo.
// =============================================================================
...
return [
    ...
    // Redis a usar (debe ser el mismo que QUEUE_CONNECTION)
    'use' => 'default',
...
// =============================================================================
// CÓMO DESPACHAR JOBS A LAS COLAS CORRECTAS
// =============================================================================
//
// Opción A: en el Job con $queue
//   class ProcessBancardPayment implements ShouldQueue
//   {
...
//   }
//
// Opción B: al despachar
//   ProcessBancardPayment::dispatch($data)->onQueue('critical');
//   GenerateStudentReport::dispatch($data)->onQueue('reports');
//   SendWelcomeEmail::dispatch($user)->onQueue('emails');
//
// =============================================================================
// PROTEGER EL DASHBOARD EN app/Providers/HorizonServiceProvider.php
// =============================================================================
//
